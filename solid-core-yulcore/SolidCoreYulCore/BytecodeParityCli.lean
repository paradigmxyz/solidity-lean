...
namespace SolidCoreYulCore.BytecodeParityCli
...
end SolidCoreYulCore.BytecodeParityCli

def main (args : List String) : IO UInt32 := do
  match SolidCoreYulCore.BytecodeParityCli.parseArgs args {} with
  | Except.error error =>
  ...
  | Except.ok cfg =>
      let result :=
        SolidCoreYulCore.BytecodeMultiContract.runFuel
          ...
          (SolidCoreYulCore.BytecodeParityCli.initialMeteredState cfg)
      SolidCoreYulCore.BytecodeParityCli.printResult cfg result
      return 0
